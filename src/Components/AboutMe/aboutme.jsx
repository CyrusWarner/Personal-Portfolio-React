...
const AboutMe = () => {
  return (
    <Container>
      ...
      believed to be my future career. I graduated from Southeastern Community
      College and decided that I would attend DevCodeCamp in hopes of learning
      things about software development I was unable to learn in college. As of
